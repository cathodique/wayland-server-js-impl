...
export declare class Connection extends EventEmitter<ConnectionEvents> {
    ...
    createObject(type: string, id: number, parent: BaseObject<DefaultEventMap, Parent>, args: Record<string, any>): import("./objects/wl_buffer.js").WlBuffer | import("./objects/wl_pointer.js").WlPointer | import("./objects/wl_keyboard.js").WlKeyboard | WlRegistry | import("./objects/wl_callback.js").WlCallback | import("./objects/wl_compositor.js").WlCompositor | import("./objects/wl_shm.js").WlShm | import("./objects/wl_shm_pool.js").WlShmPool | import("./objects/wl_seat.js").WlSeat | import("./objects/wl_subcompositor.js").WlSubcompositor | import("./objects/wl_output.js").WlOutput | import("./objects/xdg_wm_base.js").XdgWmBase | import("./objects/wl_data_device_manager.js").WlDataDeviceManager | import("./objects/wl_data_device.js").WlDataDevice | import("./objects/wl_surface.js").WlSurface | import("./objects/wl_subsurface.js").WlSubsurface | import("./objects/xdg_surface.js").XdgSurface | import("./objects/xdg_toplevel.js").XdgToplevel | import("./objects/wl_region.js").WlRegion | WlDummy;
    ...
    addCommand(obj: BaseObject<DefaultEventMap, Parent>, eventName: string, args: Record<string, any>): void;
